...
if __name__ == "__main__":
	compare_stands("C:\\src\\example-org\\example-app\\api_autotests\\response_times_dev.json", "C:\\src\\example-org\\example-app\\api_autotests\\response_times_prod.json")