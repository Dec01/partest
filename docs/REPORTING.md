...
Authorization headers are **masked** in `attach_request` (LIB-16 partial).
...
See [MIGRATION.md](MIGRATION.md) LIB-02 — disable if you already attach titles.

## Coverage extras (`partest.reports`) — LIB-COV-*
...
See [COVERAGE_REPORT.md](COVERAGE_REPORT.md).
