...
Post-gen agent loop: skill `/partest` → `references/post-gen-playbook.md`.
...
- [MIGRATION.md](MIGRATION.md) — 0.3 / 1.x / aqa → 1.5.0  
- [UI_QUICKSTART.md](UI_QUICKSTART.md) — `partest[ui]` sync BasePage  
- [README.md](README.md) — full module map  
- [IMPLEMENTATION_PLAN.md](IMPLEMENTATION_PLAN.md) — status board (library closed; aqa remaining)
