---
title: Coverage methodology — three axes
status: current
verified: 2026-09-04
sources: [partest/methodology/subtypes.py, partest/methodology/matrix.py, partest/methodology/steps.py, partest/methodology/inference.py, partest/methodology/classifier.py, partest/test_types.py]
audience: agent
ships_in_wheel: true
---
