...
status: current
verified: 2026-09-04
sources: [partest/sideeffects.py, partest/test_types.py, partest/methodology/matrix.py]
audience: user
ships_in_wheel: true
---
...
|---|---|---|
| **L0** | one HTTP operation, the axes of [[concepts/methodology]] | `coverage.json` |
...
Related: [[concepts/methodology]] · [[howto/upload]] · [[howto/ui]] · [[concepts/coverage-honesty]]
