# project_gen roadmap — scaffold suites like a mature monorepo

**Status:** G0–G6 implemented  
**Reference architecture:** aqa monorepo (`src/api` + `src/ui`, split requirements)  
**CLI:** `partest-gen`
...
SoT for agents: **`.grok/skills/partest/references/post-gen-playbook.md`**
(and skill section “After generation”).
...
See also: `docs/DEVELOPMENT.md`, skill `/partest`.
